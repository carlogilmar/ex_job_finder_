defmodule RemoteJobs.UploadOperator do
  ...
  def up_img_to_cloudinary(img_encoded_base64) do
    preset = Application.get_env(:remote_jobs,
              RemoteJobsWeb.Endpoint)[:cloudinary_preset]
    url = Application.get_env(:remote_jobs,
            RemoteJobsWeb.Endpoint)[:cloudinary_url]
