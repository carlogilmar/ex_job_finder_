defmodule RemoteJobs.ExpireOperatorTest do
  ...
  defp create_jobs_to_be_expired() do
    ...
    {:ok, job_upd1} = JobOperator.update(job1, %{status: "AVAILABLE", expire_date: expired_date1})
    {:ok, job_upd2} = JobOperator.update(job2, %{status: "AVAILABLE", expire_date: expired_date2})
    {job_upd1, job_upd2}
  end
